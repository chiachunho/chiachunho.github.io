...
export default function TopBar() {
  return (
    <header
      className="sticky top-0 z-20 grid grid-cols-1 items-start gap-4 backdrop-blur-md min-[640px]:grid-cols-[1fr_auto]"
      style={{
    ...
    >
      <div>
        ...
        >
          {PROFILE.name}
          <span className="text-muted-foreground ml-1 font-normal tracking-[-0.005em]">· {PROFILE.chineseName}</span>
        </h1>
        <p
